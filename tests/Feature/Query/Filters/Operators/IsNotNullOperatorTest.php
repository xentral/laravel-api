...
describe('Is Not Null Operator', function () {
    it('can filter by nullable date field is not null', function () {
    ...
    it('can filter by nullable string field is not null', function () {
